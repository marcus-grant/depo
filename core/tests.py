...
class ShortcodeSchemaTest(TestCase):
    def test_shortcode_field_names_types(self):
        """Test that the Shortcode entity has the expected fields"""
        # Get actual field instances in lists
        fields = Shortcode._meta.get_fields()
        ...
        for expect_field_name, expect_field_type in expected_fields.items():
            with self.subTest(field_name=expect_field_name):
                ...
                field = Shortcode._meta.get_field(expect_field_name)
    ...
    def test_id_field_constraints(self):
        ...
        id_field = Shortcode._meta.get_field("id")
    ...
    def test_ctypes_field_constraints(self):
        ...
        ctype_field = Shortcode._meta.get_field("ctype")
        self.assertEqual(getattr(ctype_field, "max_length", None), 3)
        self.assertEqual(getattr(ctype_field, "choices", None), Shortcode.CONTENT_TYPES)
    ...
    def test_url_field_constraints(self):
        ...
        url_field = Shortcode._meta.get_field("url")
    ...
    def test_btime_field_constraints(self):
        ...
        btime_field = Shortcode._meta.get_field("btime")
    ...
    def test_mtime_field_constraints(self):
        ...
        mtime_field = Shortcode._meta.get_field("mtime")
