...
# TODO: Pull out test artifact into separate module for creating & logging in users
class WebUploadViewGETTests(TestCase):
    ...
    def test_upload_requires_auth(self):
        """Access w/o credentials should redirect to login page."""
    ...
    def test_upload_view_authenticated(self):
        """Create & login a test user and ensure upload happens"""
...
# TODO: Remove or migrate these tests what is used in new Django auth code
